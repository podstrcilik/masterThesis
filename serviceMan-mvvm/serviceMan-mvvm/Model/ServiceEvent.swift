...
extension ServiceEvent {
    ...
    ServiceEvent(
        ...
        customer: Customer(id: "001", name: "Kovoservis s.r.o.", address: "Ulice 7, Město", contactName: "Jan Novák", telephoneContact: "+420 777 123 456"),
    ...
    ServiceEvent(
        ...
        customer: Customer(id: "002", name: "ZlínAutomotive a.s.", address: "Ulice 11, Město", contactName: "Kateřina Vrátilová", telephoneContact: "+420 605 123 456"),
    ...
    ServiceEvent(
        ...
        customer: Customer(id: "003", name: "Nový průmysl s.r.o.", address: "Ulice 15, Město", contactName: "Lucie Nováková", telephoneContact: "+420 603 123 456"),
